...
export default function FeaturedProductsSection() {
  ...
  return (
    <section className="bg-white py-8 md:py-12 px-4 max-w-7xl mx-auto font-sans">
      ...
      {/* Grid Layout: Mobile pe 2 columns (grid-cols-2), Desktop pe 4 (lg:grid-cols-4) */}
        ...
        {products.map((product, index) => {
          ...
          return (
            ...
            >
              ...
              {/* Action Buttons: Mobile pe height thodi kam ki hai */}
              ...
              {/* Hover Border Effect - Hidden on Touch devices for better UX */}
